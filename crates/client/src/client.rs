        ...
        cx.spawn(async move |cx| {
            ...
            let credentials = background
                ...
                .spawn(async move {
                    ...
                    // Open the /nir sign-in page in the user's browser, with query parameters that indicate
                    // that the user is signing in from a /nir app running on the same device.
