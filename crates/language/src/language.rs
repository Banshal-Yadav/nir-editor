//! The `language` crate provides a large chunk of /void's language-related
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in /void setting and keybind
    /// files
    ...
    /// for settings that should be persisted to /void's settings file.
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to /void installation
            //
...
impl LanguageScope {
    ...
    ///
    /// By default, /void treats as paragraph and comment prefixes as boundaries.
    ...
    ///
    /// By default, /void treats alphanumeric characters (and '_') as word characters for
