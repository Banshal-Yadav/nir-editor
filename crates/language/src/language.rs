//! The `language` crate provides a large chunk of /nir's language-related
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in /nir setting and keybind
    /// files
    ...
    /// for settings that should be persisted to /nir's settings file.
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to /nir installation
            //
...
impl LanguageScope {
    ...
    ///
    /// By default, /nir treats as paragraph and comment prefixes as boundaries.
    ...
    ///
    /// By default, /nir treats alphanumeric characters (and '_') as word characters for
