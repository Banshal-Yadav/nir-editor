    ...
    fn privacy_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using Nir with.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn ai_page(cx: &App) -> SettingsPage {
    ...
    fn agent_configuration_section(_cx: &App) -> Box<[SettingsPageItem]> {
        ...
        items.extend([
            ...
            SettingsPageItem::SubPageLink(SubPageLink {
                title: "Agent Memory and Logs".into(),
                r#type: Default::default(),
                json_path: Some("agent.agent_logs"),
                description: Some("View agent session history, checkpoints, log files, and memory files (about, settings, goals, projects, bookmark).".into()),
                search_aliases: &[
                    "checkpoint",
                    "history",
                    "log",
        ...
        items.extend([
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Command to automatically run when Nir creates a Terminal Thread shell in the agent panel. Runs in your configured shell.",
                field: Box::new(SettingField {
                    organization_override: None,
