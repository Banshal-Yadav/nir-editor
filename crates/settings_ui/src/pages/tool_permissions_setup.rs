...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions only apply to the /nir native agent and don’t extend to external agents connected through the Agent Client Protocol (ACP).";
