---
name: create-skill
description: Helps you create new agent skills for /nir. Use this to create a skill, ask about SKILLs.md, or package reusable agent instructions.
---

# Creating a /nir Agent Skill

Use this skill when the user wants to create, edit, or understand agent skills in /nir.
