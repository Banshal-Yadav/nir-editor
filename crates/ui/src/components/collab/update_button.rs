...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::LoadCircle, "Checking for /nir updates…")
            .icon_animate(true)
            .disabled(true)
    }

    pub fn downloading(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::Download, "Downloading /nir update…")
            .tooltip(version)
            .disabled(true)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::LoadCircle, "Installing /nir update…")
            .icon_animate(true)
            .tooltip(version)
            .disabled(true)
    }
    ...
    pub fn errored(error: impl Into<SharedString>) -> Self {
        Self::new(IconName::Warning, "Failed to update /nir")
