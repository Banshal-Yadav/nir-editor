...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::ArrowCircle, "Checking for /void updates…").icon_animate(true)
    }

    pub fn downloading(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::Download, "Downloading /void update…").tooltip(version)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::ArrowCircle, "Installing /void update…")
            .icon_animate(true)
            .tooltip(version)
    }
    ...
    pub fn errored(error: impl Into<SharedString>) -> Self {
        Self::new(IconName::Warning, "Failed to update /void")
