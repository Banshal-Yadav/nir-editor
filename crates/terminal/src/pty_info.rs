...
/// Fetches /void-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, emitting a [`Event::TitleChanged`] event if the /void-relevant info has changed
