...
/// Fetches /nir-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, emitting a [`Event::TitleChanged`] event if the /nir-relevant info has changed
