...
impl CopilotCodeVerification {
    ...
    fn render_prompting_modal(
        ...
        v_flex()
            ...
            .items_center()
            .text_center()
            .child(Headline::new("Use GitHub Copilot in /nir").size(HeadlineSize::Large))
            .child(
...
impl ConfigurationView {
    ...
    fn render_for_chat(&self) -> impl IntoElement {
        let start_label = "To use /nir's agent with GitHub Copilot, you need to be logged in to GitHub. Note that your GitHub account must have an active Copilot Chat subscription.";
