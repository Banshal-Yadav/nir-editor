...
impl CopilotCodeVerification {
    ...
    fn render_prompting_modal(
        ...
        v_flex()
            ...
            .items_center()
            .text_center()
            .child(Headline::new("Use GitHub Copilot in /void").size(HeadlineSize::Large))
            .child(
...
impl Render for CopilotCodeVerification {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(
                Vector::new(VectorName::VoidXCopilot, rems(8.), rems(4.))
...
impl ConfigurationView {
    ...
    fn render_for_chat(&self) -> impl IntoElement {
        let start_label = "To use /void's agent with GitHub Copilot, you need to be logged in to GitHub. Note that your GitHub account must have an active Copilot Chat subscription.";
