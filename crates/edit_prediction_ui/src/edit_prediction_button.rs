...
const PRIVACY_DOCS: &str = "https://github.com/Banshal-Yadav/nir-editor/wiki";
                        ...
                        IconButton::new("zed-predict-pending-button", ep_icon)
                            ...
                            .on_click(cx.listener(move |_, _, window, cx| {
                                ...
                                window.dispatch_action(
                                    zed_actions::OpenNirPredictOnboarding.boxed_clone(),
                                    cx,
                                );
                            })),
                    );
            ...
            if needs_sign_in {
                    ...
                    .and_then(|provider| provider.usage(cx))
                {
                    ...
                    menu = menu
                        ...
                        .entry("Upgrade to /nir Pro or contact us.", None, |_window, cx| {
                            telemetry::event!(
                                "Edit Prediction Menu Action",
                                action = "upsell_clicked",
                                reason = "account_age",
...
fn render_zeta_tab_animation(cx: &App) -> impl IntoElement {
    ...
    h_flex()
        ...
        .child(Icon::new(IconName::NirPredict))
