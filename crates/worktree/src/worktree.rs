...
///
/// Has an absolute path, and may be set to be visible in /nir UI or not.
...
/// * a directory opened in /nir — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        //
        // Certain directories may have FS changes, but do not lead to git data changes that /nir cares about.
        // Ignore these, to avoid /nir unnecessarily rescanning git metadata.
