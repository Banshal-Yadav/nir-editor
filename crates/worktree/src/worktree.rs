...
///
/// Has an absolute path, and may be set to be visible in /void UI or not.
...
/// * a directory opened in /void — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        //
        // Certain directories may have FS changes, but do not lead to git data changes that /void cares about.
        // Ignore these, to avoid /void unnecessarily rescanning git metadata.
