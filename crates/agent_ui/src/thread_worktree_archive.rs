...
/// Resolves the /nir-managed worktrees base directory for a given repo.
///
/// This intentionally reads the *global* `git.worktree_directory` setting
/// rather than any project-local override, because /nir always uses the
...
pub fn build_root_plan(
    ...
    // Only archive worktrees that live inside the /nir-managed worktrees
