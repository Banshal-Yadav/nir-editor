...
pub const DOCS_URL: &str = "https://nir.placeholder/coming-soon";
...
actions!(
    ...
    [
        ...
        SignIn,
        /// Open the user account in /nir while in the onboarding flow.
        OpenAccount,
                            ...
                            .child(
                                h_flex()
                                    ...
                                    .child(
                                        h_flex()
                                            .gap_4()
                                            .child(Vector::square(VectorName::NirLogo, rems(2.5)))
                                            .child(
                                                v_flex()
                                                    .child(
                                                        div()
