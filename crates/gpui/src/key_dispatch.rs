...
//! (Though mostly when developing /nir itself, you just need to add a new line to
...
//! bubbles up from the bottom. For example in /nir, the Workspace is the top-level view, which contains Pane's, which contain Editors. If there are conflicting keybindings defined
