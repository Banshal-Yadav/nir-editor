...
///
/// Feature flags are enabled for members of /void staff by default. To disable this behavior
/// so you can test flags being disabled, set ZED_DISABLE_STAFF=1 in your environment,
/// which will force /void to treat the current user as non-staff.
pub trait FeatureFlag {
    ...
    /// Returns whether this feature flag is enabled for /void staff.
