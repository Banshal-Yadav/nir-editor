                            ...
                            .when(!is_compatible, |upgrade_button| {
                                upgrade_button.disabled(true).tooltip({
                                    ...
                                    move |_, cx| {
                                        Tooltip::simple(
                                            format!(
                                                "v{version} is not compatible with this version of /nir.",
                                            ),
                                             cx,
                                        )
                                    }
        ...
        for feature in &self.upsells {
            let banner = match feature {
                Feature::AgentClaude => self.render_feature_upsell_banner(
                    "Claude Agent support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::AgentCodex => self.render_feature_upsell_banner(
                    "Codex CLI support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::AgentGemini => self.render_feature_upsell_banner(
                    "Gemini CLI support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionBasedpyright => self.render_feature_upsell_banner(
                    "Basedpyright (Python language server) support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionRuff => self.render_feature_upsell_banner(
                    "Ruff (linter for Python) support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTailwind => self.render_feature_upsell_banner(
                    "Tailwind CSS support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::ExtensionTy => self.render_feature_upsell_banner(
                    "Ty (Python language server) support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::Git => self.render_feature_upsell_banner(
                    "/nir comes with basic Git support—more features are coming in the future."
                        .into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ...
                Feature::LanguageBash => self.render_feature_upsell_banner(
                    "Shell support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
                Feature::LanguageC => self.render_feature_upsell_banner(
                    "C support is built-in to /nir!".into(),
                    "https://github.com/Banshal-Yadav/nir-editor/wiki".into(),
                    false,
                    cx,
                ),
