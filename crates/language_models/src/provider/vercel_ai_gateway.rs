    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(
                    "To use /void's agent with Vercel AI Gateway, you need to add an API key. Follow these steps:",
                ))
                .child(
                    List::new()
                        .child(
