                            ...
                            for part in &tool_result.content {
                                match part {
                                    ...
                                    LanguageModelToolResultContent::Image(_) => {
                                        text_parts.push("[Tool responded with an image, but /void doesn't support these in Mistral models yet]".to_string());
                                    }
                                }
                            }
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use /void's agent with Mistral, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
