        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new(format!("To use {}, you need to add an API key. Follow these steps:", match &self.target_agent {
                    ConfigurationViewTargetAgent::VoidAgent => "/void's agent with Google AI".into(),
                ...
                .child(
                    Label::new(
                        format!("You can also set the {GEMINI_API_KEY_VAR_NAME} environment variable and restart /void."),
                    )
