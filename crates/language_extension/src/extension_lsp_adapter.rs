    ...
    fn get_language_server_command(
        ...
        async move {
            let ret = maybe!(async move {
                ...
                // /nir extension API, but we're leaving these existing usages in place temporarily
                // to avoid any compatibility issues between /nir and the extension versions.
                //
