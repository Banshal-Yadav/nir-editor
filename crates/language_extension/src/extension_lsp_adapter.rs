    ...
    fn get_language_server_command(
        ...
        async move {
            let ret = maybe!(async move {
                ...
                // /void extension API, but we're leaving these existing usages in place temporarily
                // to avoid any compatibility issues between /void and the extension versions.
                //
