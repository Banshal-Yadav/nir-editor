...
pub struct LanguageConfig {
    ...
    /// Used when a kernel's `language` field differs from /nir's language name.
    ...
    /// A list of characters that /nir should treat as word characters for the
    ...
    /// A list of characters that /nir should treat as word characters for completion queries.
    #[serde(default)]
    pub completion_query_characters: HashSet<char>,
    /// A list of characters that /nir should treat as word characters for linked edit operations.
    #[serde(default)]
