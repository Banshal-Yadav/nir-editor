---
title: Icon Themes
description: "Icon Themes for /nir extensions."
---

# Icon Themes

Extensions may provide icon themes to change the icons /nir uses for folders and files.
...
Each icon theme file should adhere to the JSON schema specified at [`https://github.com/Banshal-Yadav/nir-editor"$schema": "https://github.com/Banshal-Yadav/nir-editor",
"name": "My Icon Theme",
"author": "Your Name",
"themes": [
{
