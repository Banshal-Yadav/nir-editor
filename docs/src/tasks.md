...
When you have a task definition that is bound to the runnable, you can quickly run it using [Code Actions](https://github.com/Banshal-Yadav/nir-editor/wiki"task" and select **task: spawn** 3. Select the script from the list
