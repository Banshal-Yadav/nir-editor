...
This is built on push to `main` and published automatically to [https://github.com/Banshal-Yadav/nir/wiki's important to note the version number above. For an unknown reason, as of 2025-04-23, running 0.4.48 will cause odd URL behavior that breaks things.
